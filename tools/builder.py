...
class MultiStepWithWarmupLR(optim.lr_scheduler.LambdaLR):
    def __init__(
        self,
        optimizer,
        milestones,
...
def build_opti_sche(base_model, config):
    ...
    elif sche_config.type == 'WarmMultiStepLR':
        scheduler =  MultiStepWithWarmupLR(optimizer, **sche_config.kwargs)
